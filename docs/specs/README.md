...
| [011-milestone-centric-cards](011-milestone-centric-cards/spec.md) | 011-05 — map worktrees/PRs to their milestone | **DONE** |  |
...
| [015-manager-card-redesign](015-manager-card-redesign/spec.md) | 015-01 — card shell, overflow discipline, drop the workstream dump | **DONE** |  |
| [015-manager-card-redesign](015-manager-card-redesign/spec.md) | 015-02 — compact milestone line + progress-scope label | **DONE** |  |
| [015-manager-card-redesign](015-manager-card-redesign/spec.md) | 015-03 — stat-tile row | **DONE** |  |
| [015-manager-card-redesign](015-manager-card-redesign/spec.md) | 015-04 — SVG sparklines | **DONE** |  |
