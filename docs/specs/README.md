...
| [005-central-observation-ingest-boundary](005-central-observation-ingest-boundary/spec.md) | 005-01 — authenticated ingest endpoint | DRAFT | ADR-0007/0008 accepted 2026-08-03 (token baseline); DoR unblocked |
...
| [006-edge-collection-client](006-edge-collection-client/spec.md) | 006-01 — local observation emitter | DRAFT | ADR-0007 accepted 2026-08-03; DoR unblocked |
