...
records the genuine first unit of work in `project-dashboard`: adopting
jig by running `scaffold-init` to lay down the docs tree, CLAUDE.md, the
status board, and the runtime machinery under `.claude/`.
